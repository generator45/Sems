...
int pds_load_ndx()
{
    ...
    if (repo_handle.repo_status == PDS_REPO_OPEN)
    {
        ...
        // }
        // fseek(fp, 0, SEEK_SET);
        int numsRead = fread(repo_handle.ndx_array, sizeof(struct PDS_NdxInfo), repo_handle.rec_count, fp);
        // if (numsRead < repo_handle.rec_count)
        //     return PDS_FILE_ERROR;
        return PDS_SUCCESS;
    }
...
int pds_open(char *repo_name, int rec_size)
{
    ...
    int numrecs;
    fread(&numrecs, sizeof(int), 1, fi);
    repo_handle.rec_count = numrecs;
...
int put_rec_by_key(int key, void *rec)
{
    if (repo_handle.repo_status == PDS_REPO_OPEN)
    {
        ...
        struct PDS_NdxInfo pds_ndx_info = {key, pos};
        // repo_handle.ndx_array[repo_handle.rec_count].key = key;
        // repo_handle.ndx_array[repo_handle.rec_count].offset = pos;
...
//         if (repo_handle.ndx_array[i].key == key)
//         {
//             printf("key:  %d", repo_handle.ndx_array[i].key);
//             return PDS_ADD_FAILED;
//         }
//     }
...
//     repo_handle.ndx_array[repo_handle.rec_count] = pds_ndx_info;
//     repo_handle.rec_count++;
//     int keychk = fwrite(&key, sizeof(int), 1, fp);
//     if (keychk < 1)
//     {
//         return PDS_ADD_FAILED;
//     }
//     int reccheck = fwrite(rec, sizeof(rec), 1, fp);
//     if (reccheck < 1)
//     {
//         return PDS_ADD_FAILED;
//     }
